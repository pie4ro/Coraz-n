...
* **Sincronización Musical:** Reproducción de audio con subtítulos flotantes sincronizados al ritmo de la canción.
* **Lluvia de Corazones:** Animación de emojis flotantes de amor que recorren la pantalla de forma fluida.
* **Diseño Responsivo:** Adaptado tanto para computadoras como para dispositivos móviles.
...
* **JavaScript (Vanilla)** (Lógica del universo, canvas, gestión de eventos y sincronización de subtítulos)
